<template>
    <div class="card mt-5 p-5">
        ...
        <!-- Comments START -->
        <div class="media my-3" v-for="(comment, index) in comments.data">
        <!-- <img width="30" height="30" class="rounded-circle mr-3" src="https://piscum.photos/id/42/200/200">-->
            ...
            <div class="media-body">
                ...
                <div class="d-flex">
                    ...
                    <button class="btn-sm btn-default ml-2">Add reply</button>
                </div>
                <!-- Votes Component END -->
                ...
                axios.get(this.comments.next_page_url)
                    .then( ({data}) => {
                        this.comments = {
                            ...
                            data: [
                                ...this.comments.data, // array of with records/objects/models already existing or empty if first time
                                ...data.data // new records/objects/models from response.data.data
                            ]
